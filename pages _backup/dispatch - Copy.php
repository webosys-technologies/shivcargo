				...
				<div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<?php	
								if(isset($_GET["tab"]) && isset($_GET["bok_memo"]) && isset($_GET["driv_id"]))
								{
									$sql="select * from drivers where driv_id=".$_GET["driv_id"];
									$res=mysql_query($sql);
									$count=mysql_num_rows($res);
									$sql_memo="select bok_loaddate from booking where bok_memo=".$_GET["bok_memo"];
									$res_memo=mysql_query($sql_memo);
									$count_memo=mysql_num_rows($res_memo);
									if($count>0 && $count_memo>0)
									{
								...
								?>
									...
									<span class="section">
										<b>Driver Name :</b> <?php echo ucwords($f["driv_name"]);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>MEMO NO :</b><?php echo $_GET["bok_memo"];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>MEMO DATE :</b><?php echo $f_memo["bok_loaddate"];?><br/><b>Transport Name :</b> 
										<?php echo ucwords($f["driv_tranname"]);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>VECHILE NO :</b><?php echo $f["driv_vehicelno"];?><br/> <b>DRIVER ADDRESS:</b><?php echo $f["driv_address"];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<b>DRIVER CONTACT NUMBER:</b><?php echo ucwords($f["driv_mobno"]);?>  
									</span>	
