...
//				                       
							...
							{ 
								if($row["bok_parcel"]=="Small") { $smltotal=$smltotal+1; }
								if($row["bok_parcel"]=="Big") { $bigtotal=$bigtotal+1; } 
								$total=$total+$row["bok_total"];
							?>
                                <form method="post" action="">
								<tr class="even pointer">
                                                                        <td class="a-center "> <?php echo $row["dcty_name"]; ?></td>
                                                                        <td class="a-center "> <?php if($row["bok_parcel"]=="Small") { echo "1"; } else { echo "0";}?></td>
									 <td class="a-center "> <?php if($row["bok_parcel"]=="Big") { echo "1"; } else { echo "0";}?></td>
