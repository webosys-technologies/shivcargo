							...
							<div class="x_panel">
                                ...
                                <div class="x_content">
									...
									<input type="hidden" name="do" value="home">
                                       ...
                                       <center> <span class="section"><b>SEARCH HOME REPORT</b></span></center>
...
<?php
if(isset($_GET["bok_descityid"]) || isset($_GET["gst"]) || isset($_GET["date"]) || isset($_GET["lr"]))
{ 
	$lr=$_GET["lr"];
        $date=$_GET["date"];
        $gst=$_GET["gst"];
