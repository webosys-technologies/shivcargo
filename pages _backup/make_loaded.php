				...
				<div class="x_panel"> 
                    ...
                    <div class="x_content" id="printableArea">
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
							...
							{
								$sql="select * from booking bok join des_cities dc on (bok.bok_descityid=dc.dcty_id) join des_city_place dcp on (bok.bok_cityplaceid=dcp.dcplace_id) join sender s on (bok.bok_senderid=s.sendid) join recivers r on (bok.bok_reciverid=r.recvid) where bok.bok_descityid='$bok_descityid' && bok_status='0'";	
							}	
							...
							?> 
								<tr class="even pointer">
                                  ...
                                  ` <td class="a-center "> <input id="name" class="form-control col-md-7 col-xs-12" placeholder="Enter Ammount" name="bok_total<?php echo $row["bokid"]; ?>" value="<?php echo $row["bok_total"]; ?>" type="text"> </td> 
                                    ...
                                    <td class="a-center "> <input id="name" class="form-control col-md-7 col-xs-12" placeholder="Enter Cross Charge" name="bok_cross<?php echo $row["bokid"]; ?>" value="<?php echo $row["dcplace_crossing"]; ?>" type="text"> </td> 
                                </tr> 
							<?php $SrNo++; } ?>		
                            </tbody>
						</table>
